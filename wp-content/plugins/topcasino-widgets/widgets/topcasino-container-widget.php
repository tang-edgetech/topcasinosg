...
class TopcasinoContainerWidget extends \Elementor\Widget_Base {
	...
	// 	return 'topcasino_container_widget';
	// }
	...
	public function get_title() {
		return esc_html__( 'TopCasino Container', 'topcasinosg_widgets' );
	}
	...
	public function get_keywords() {
		return [ 'Container', 'Flex', 'Flexbox', 'Flexbox Container', 'Grid', 'Grid Container', 'CSS Grid', 'Layout', 'TopCasinoSG' ];
	}

    public function get_categories() {
        return [ 'basic' ]; // Or make your own category
    }
		...
		return [
			'container_grid' => [
				'replacements' => [
					...
					'title' => esc_html__( 'Grid', 'topcasinosg_widgets' ),
					...
					'custom' => [
						...
						'preset_settings' => [
							'container_type' => 'grid',
							'presetTitle' => esc_html__( 'Grid', 'topcasinosg_widgets' ),
	...
	protected function register_container_layout_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Container', 'topcasinosg_widgets' ),
		...
		$this->add_control(
			'container_type',
			[
				'label' => esc_html__( 'Container Layout', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flex',
				'prefix_class' => 'e-',
				'options' => [
					'flex' => esc_html__( 'Flexbox', 'topcasinosg_widgets' ),
					'grid' => esc_html__( 'Grid', 'topcasinosg_widgets' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'content_width',
			[
				'label' => esc_html__( 'Content Width', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'boxed',
				'options' => [
					'boxed' => esc_html__( 'Boxed', 'topcasinosg_widgets' ),
					'full' => esc_html__( 'Full Width', 'topcasinosg_widgets' ),
				],
		...
		$width_control_settings = [
			'label' => esc_html__( 'Width', 'topcasinosg_widgets' ),
		...
		$this->add_responsive_control(
			'min_height',
			[
				'label' => esc_html__( 'Min Height', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SLIDER,
				...
				'description' => sprintf(
					esc_html__( 'To achieve full height Container use %s.', 'topcasinosg_widgets' ),
					'100vh'
				),
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'gap' => [
						'label' => esc_html__( 'Gaps', 'topcasinosg_widgets' ),
						'device_args' => [
							Breakpoints_Manager::BREAKPOINT_KEY_DESKTOP => [
	...
	protected function register_items_layout_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Additional Options', 'topcasinosg_widgets' ),
				'tab' => Controls_Manager::TAB_LAYOUT,
			]
		);
		...
		$this->add_control(
			'overflow',
			[
				'label' => esc_html__( 'Overflow', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => esc_html__( 'Default', 'topcasinosg_widgets' ),
					'hidden' => esc_html__( 'Hidden', 'topcasinosg_widgets' ),
					'auto' => esc_html__( 'Auto', 'topcasinosg_widgets' ),
				],
				'selectors' => [
		...
		$possible_tags = [
			...
			'aside' => 'aside',
			'nav' => 'nav',
			'a' => 'a ' . esc_html__( '(link)', 'topcasinosg_widgets' ),
		];
		...
		$this->add_control(
			'html_tag',
			[
				'label' => esc_html__( 'HTML Tag', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => $options,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'alert_type' => 'warning',
				'content' => esc_html__( 'Don’t add links to elements nested in this container - it will break the layout.', 'topcasinosg_widgets' ),
				'condition' => [
					'html_tag' => 'a',
				],
			]
		...
		$this->add_control(
			'link',
			[
				'label' => esc_html__( 'Link', 'topcasinosg_widgets' ),
	...
	protected function register_background_controls() {
		$this->start_controls_section(
			'section_background',
			[
				'label' => esc_html__( 'Background', 'topcasinosg_widgets' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Normal', 'topcasinosg_widgets' ),
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Hover', 'topcasinosg_widgets' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Transition Duration', 'topcasinosg_widgets' ) . ' (s)',
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0.3,
				],
	...
	protected function register_background_overlay_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Overlay', 'topcasinosg_widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Opacity', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => .5,
				],
		...
		$this->add_control(
			'overlay_blend_mode',
			[
				'label' => esc_html__( 'Blend Mode', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Normal', 'topcasinosg_widgets' ),
					'multiply' => esc_html__( 'Multiply', 'topcasinosg_widgets' ),
					'screen' => esc_html__( 'Screen', 'topcasinosg_widgets' ),
					'overlay' => esc_html__( 'Overlay', 'topcasinosg_widgets' ),
					'darken' => esc_html__( 'Darken', 'topcasinosg_widgets' ),
					'lighten' => esc_html__( 'Lighten', 'topcasinosg_widgets' ),
					'color-dodge' => esc_html__( 'Color Dodge', 'topcasinosg_widgets' ),
					'saturation' => esc_html__( 'Saturation', 'topcasinosg_widgets' ),
					'color' => esc_html__( 'Color', 'topcasinosg_widgets' ),
					'luminosity' => esc_html__( 'Luminosity', 'topcasinosg_widgets' ),
				],
				'selectors' => [
	...
	protected function register_border_controls() {
		$this->start_controls_section(
			'section_border',
			[
				'label' => esc_html__( 'Border', 'topcasinosg_widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'border_radius',
			[
				'label' => esc_html__( 'Border Radius', 'topcasinosg_widgets' ),
	...
	protected function register_shape_dividers_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Shape Divider', 'topcasinosg_widgets' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$shapes_options = [
			'' => esc_html__( 'None', 'topcasinosg_widgets' ),
		];
		...
		foreach ( [
			'top' => esc_html__( 'Top', 'topcasinosg_widgets' ),
			'bottom' => esc_html__( 'Bottom', 'topcasinosg_widgets' ),
		] as $side => $side_label ) {
			...
			$this->add_control(
				$base_control_key,
				[
					'label' => esc_html__( 'Type', 'topcasinosg_widgets' ),
					'type' => Controls_Manager::SELECT,
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Color', 'topcasinosg_widgets' ),
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Height', 'topcasinosg_widgets' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem', 'custom' ],
					'range' => [
						'px' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Flip', 'topcasinosg_widgets' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Invert', 'topcasinosg_widgets' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Bring to Front', 'topcasinosg_widgets' ),
					'type' => Controls_Manager::SWITCHER,
					'selectors' => [
	...
	protected function register_advanced_controls() {
		$this->start_controls_section(
			'section_layout',
			[
				'label' => esc_html__( 'Layout', 'topcasinosg_widgets' ),
		...
		$this->add_responsive_control(
			'margin',
			[
				'label' => esc_html__( 'Margin', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'custom' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'padding',
			[
				'label' => esc_html__( 'Padding', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'custom' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Grid Item', 'topcasinosg_widgets' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'grid_column',
			[
				'label' => esc_html__( 'Column Span', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => ' Default',
					'1' => '1',
		...
		$this->add_responsive_control(
			'grid_column_custom',
			[
				'label' => esc_html__( 'Custom', 'topcasinosg_widgets' ),
		...
		$this->add_responsive_control(
			'grid_row',
			[
				'label' => esc_html__( 'Row Span', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => ' Default',
					'1' => '1',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::ALERT,
				'alert_type' => 'warning',
				'heading' => esc_html__( 'Please note!', 'topcasinosg_widgets' ),
				'content' => esc_html__( 'Custom positioning is not considered best practice for responsive web design and should not be used too frequently.', 'topcasinosg_widgets' ),
				'render_type' => 'ui',
				'condition' => [
					'position!' => '',
				],
		...
		$this->add_control(
			'position',
			[
				'label' => esc_html__( 'Position', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => esc_html__( 'Default', 'topcasinosg_widgets' ),
					'absolute' => esc_html__( 'Absolute', 'topcasinosg_widgets' ),
					'fixed' => esc_html__( 'Fixed', 'topcasinosg_widgets' ),
				],
				'selectors' => [
		...
		$left = esc_html__( 'Left', 'topcasinosg_widgets' );
		$right = esc_html__( 'Right', 'topcasinosg_widgets' );
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Horizontal Orientation', 'topcasinosg_widgets' ),
		...
		$this->add_responsive_control(
			'_offset_x',
			[
				'label' => esc_html__( 'Offset', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -1000,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Orientation', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::CHOOSE,
				'toggle' => false,
				'default' => 'start',
				'options' => [
					'start' => [
						'title' => esc_html__( 'Top', 'topcasinosg_widgets' ),
						'icon' => 'eicon-v-align-top',
					],
					'end' => [
						'title' => esc_html__( 'Bottom', 'topcasinosg_widgets' ),
		...
		$this->add_responsive_control(
			'z_index',
			[
				'label' => esc_html__( 'Z-Index', 'topcasinosg_widgets' ),
		...
		$this->add_control(
			'_element_id',
			[
				'label' => esc_html__( 'CSS ID', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'ai' => [
					'active' => false,
				...
				'title' => esc_html__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'topcasinosg_widgets' ),
		...
		$this->add_control(
			'css_classes',
			[
				'label' => esc_html__( 'CSS Classes', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'ai' => [
					'active' => false,
				...
				'prefix_class' => '',
				'title' => esc_html__( 'Add your custom class WITHOUT the dot. e.g: my-class', 'topcasinosg_widgets' ),
				'classes' => 'elementor-control-direction-ltr',
			]
		);
	...
	protected function register_motion_effects_controls() {
		$this->start_controls_section(
			'section_effects',
			[
				'label' => esc_html__( 'Motion Effects', 'topcasinosg_widgets' ),
				'tab' => Controls_Manager::TAB_ADVANCED,
			]
		);
		...
		$this->add_responsive_control(
			'animation',
			[
				'label' => esc_html__( 'Entrance Animation', 'topcasinosg_widgets' ),
		...
		$this->add_control(
			'animation_duration',
			[
				'label' => esc_html__( 'Animation Duration', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'slow' => esc_html__( 'Slow', 'topcasinosg_widgets' ),
					'' => esc_html__( 'Normal', 'topcasinosg_widgets' ),
					'fast' => esc_html__( 'Fast', 'topcasinosg_widgets' ),
				],
		...
		$this->add_control(
			'animation_delay',
			[
				'label' => esc_html__( 'Animation Delay', 'topcasinosg_widgets' ) . ' (ms)',
				'type' => Controls_Manager::NUMBER,
				'default' => '',
				'min' => 0,
				'step' => 100,
	...
	protected function register_responsive_controls() {
		$this->start_controls_section(
			'_section_responsive',
			[
				'label' => esc_html__( 'Responsive', 'topcasinosg_widgets' ),
				'tab' => Controls_Manager::TAB_ADVANCED,
			]
		);
		...
		$this->add_control(
			'heading_visibility',
			[
				'label' => esc_html__( 'Visibility', 'topcasinosg_widgets' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'raw' => sprintf(
					...
					esc_html__( 'Responsive visibility will take effect only on %1$s preview mode %2$s or live page, and not while editing in Elementor.', 'topcasinosg_widgets' ),
		...
		add_action( 'elementor/element/container/_section_transform/after_section_start', function( Container $container ) {
			...
			$container->add_control(
				...
				[
					'type' => Controls_Manager::ALERT,
					'alert_type' => 'warning',
					'content' => esc_html__( 'Note: Avoid applying transform properties on sticky containers. Doing so might cause unexpected results.', 'topcasinosg_widgets' ),
				]
			);
		} );
	}
